...
public class Main {
    public static void main(String[] args) {
        ...
        Guitarra g1 = new Guitarra("Guitarra", volumen, costoMantenimientoBase);
        ...
        Piano p1 = new Piano("Piano", volumen, costoMantenimientoBase);
        ...
        Bateria b1 = new Bateria("Bateria", volumen, costoMantenimientoBase);
